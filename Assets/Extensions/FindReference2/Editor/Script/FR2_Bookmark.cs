...
namespace vietlabs.fr2
{
	...
	{	
		...
		public static void Add(string guid)
		{
			...
			{
				Logger.Warming("Invalid GUID: " + guid);
				return;
			}

			guidSet.Add(guid);
			dirty = true;
			//if (GLog.IsLogInfoEnabled) GLog.LogInfo(instSet.Count + " : " + guidSet.Count);
		}
		...
		public static void Add(FR2_Ref rf)
		{
			...
			if (rf.isSceneRef)
			{
                //if (GLog.IsLogInfoEnabled) GLog.LogInfo("add " + rf.component);
                Add(rf.component);
			}
			else
			{
		...
		public static void Remove(FR2_Ref rf)
		{
			...
			if (rf.isSceneRef)
			{
                //if (GLog.IsLogInfoEnabled) GLog.LogInfo("remove: " + rf.component);
                Remove(rf.component);
			}
			else
			{
		...
		public void RefreshView()
		{
			...
			//if (GLog.IsLogInfoEnabled) GLog.LogInfo("RefreshView: " + refs.Count);
			dirty = false;
		}
